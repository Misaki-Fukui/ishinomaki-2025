...
export const Question = () => {
  return (
    <div className="bg-white w-full min-w-[1280px] min-h-[832px] relative">
      <div className="absolute top-0 left-[calc(50.00%_-_640px)] w-[1280px] h-[431px] bg-[#7153d6] rounded-[0px_0px_100px_100px]" />

      <QuestionSet
        answerAText="A.　石ノ森章太郎"
        answerBText="B.　鳥山明"
        answerCText="C.　藤子・F・不二雄"
        ...
        question="石巻市出身で、『サイボーグ009』や『仮面ライダー』など数多くの人気作品を生み出した、日本の有名な漫画家は誰でしょう？"
      />

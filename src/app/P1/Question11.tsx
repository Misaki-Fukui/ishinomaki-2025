...
export const Question = () => {
  return (
    <div className="bg-white w-full min-w-[1280px] min-h-[832px] relative">
      <div className="absolute top-0 left-[calc(50.00%_-_640px)] w-[1280px] h-[423px] bg-[#7153d6] rounded-[0px_0px_100px_100px]" />

      <QuestionSet
        answerAText="A.　宮城県慶長使節船ミュージアム"
        answerBText="B.　東北歴史博物館"
        answerCText="C.　みちのく伊達政宗歴史館"
        ...
        question="江戸時代初期、伊達政宗の命を受け、ヨーロッパへ渡った使節団が乗った復元船が展示されていた博物館は何でしょう？"
      />

...
export const Question = () => {
  return (
    <div className="bg-white w-full min-w-[1280px] min-h-[832px] relative">
      ...
      <QuestionSet
        answerAText="A.　石ノ森健太郎"
        answerBText="B.　石ノ森章太郎"
        answerCText="C.　石ノ森萬太郎"
        ...
        question="石巻市にある「石ノ森萬画館」は、以下の誰を記念し建設しましたか？"
      />
      <div className="inline-flex items-center justify-center gap-6 p-10 absolute right-0 bottom-0 rounded-[50px_0px_0px_0px] border-variable-collection-color">
        <div className="inline-flex flex-col items-end justify-end gap-10 px-0 py-1 relative self-stretch flex-[0_0_auto]">
          <div className="inline-flex gap-[5px] flex-[0_0_auto] flex-col items-center relative">
            <div className="w-fit mt-[-1.00px] font-text font-[number:var(--text-font-weight)] text-variable-collection-grey text-[length:var(--text-font-size)] text-center leading-[var(--text-line-height)] whitespace-nowrap relative tracking-[var(--text-letter-spacing)] [font-style:var(--text-font-style)]">
              答え時間
            </div>
            ...
            <div className="inline-flex items-center justify-center gap-2.5 p-3 relative flex-[0_0_auto] bg-variable-collection-color-20 rounded-xl">
              ...
              <div className="w-fit mt-[-1.00px] font-h2 font-[number:var(--h2-font-weight)] text-[#7152d5] text-[length:var(--h2-font-size)] text-center leading-[var(--h2-line-height)] relative tracking-[var(--h2-letter-spacing)] [font-style:var(--h2-font-style)]">
                5秒
              </div>
            </div>
          </div>

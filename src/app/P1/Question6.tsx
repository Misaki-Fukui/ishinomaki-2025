...
export const Question = () => {
  return (
    <div className="bg-white w-full min-w-[1280px] min-h-[832px] relative">
      <div className="absolute top-0 left-[calc(50.00%_-_640px)] w-[1280px] h-[408px] bg-[#7153d6] rounded-[0px_0px_100px_100px]" />
      ...
      <QuestionSet
        ...
        question="三陸沖の金華山周辺で獲れる、特に脂の乗りが良いことで知られ、石巻の高級ブランドとして有名なサバは何と呼ばれていますか？"
      />
